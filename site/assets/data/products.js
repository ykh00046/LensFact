window.LENSFACT_PRODUCTS = [
  {
    ...
    aliases: ["아큐브 오아시스 원데이", "ACUVUE OASYS 1-Day", "senofilcon A"],
    name: "아큐브 오아시스 원데이®",
  ...
  },
  {
    id: "dailies-total1",
    slug: "dailies-total1",
    aliases: ["데일리스 토탈원", "DAILIES TOTAL1", "delefilcon A"],
  ...
  },
  {
    id: "biofinity",
    slug: "biofinity",
    aliases: ["바이오피니티", "Biofinity", "comfilcon A"],
    ...
    fields: [
      ...
      {
        id: "thickness", value: "공식 자료에서 확인되지 않음", state: "unknown", flag: "확인되지 않음",
        sourceSummary: "검토한 공식 자료에서 중심두께 항목을 확인하지 못함 · 2026.08.28 재확인",
        caution: "2026-08-27 기록에는 미국 전문가 페이지 기준 0.08 mm가 적혀 있었으나 2026-08-28 재확인에서 한국 제품 페이지·한국 2023 사양서·미국 전문가 페이지 어디에도 중심두께 항목이 없어 값을 철회함",
  ...
  },
  {
    ...
    aliases: ["원데이 아큐브 모이스트", "1-DAY ACUVUE MOIST", "etafilcon A"],
    name: "원데이 아큐브 모이스트®",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        value: "수허 15-322 호",
        state: "verified",
        sourceSummary: "한국 공식 제품 목록의 수허 15-322호와 MFDS UDI 모델명 Clariti 1day의 수허 15-322 호가 일치 · 같은 제품 명칭의 별도 등록 수허 19-346 호는 따로 표기",
        caution: "MFDS UDI에는 같은 업체 제품 명칭 '산소렌즈 clariti 1day'로 등록된 별도 허가번호 `수허 19-346 호`(모델명 Somofilcon A 1day · WATER FINE)도 있습니다. 실물 포장의 허가번호로 어느 등록에 해당하는지 확인해야 하며, 이 페이지는 한국 공식 목록과 MFDS 모델명 Clariti 1day가 일치하는 `수허 15-322 호`를 표시합니다.",
        sources: [
          {
            sourceType: "한국 공식 페이지·IFU",
            verifiedAt: "2026-08-28",
  ...
  },
  {
    ...
    aliases: ["데일리스 아쿠아컴포트 플러스", "DAILIES AquaComfort Plus", "아쿠아렌즈", "아쿠아 렌즈", "nelfilcon A"],
    name: "데일리스 아쿠아컴포트 플러스® / DAILIES® AquaComfort Plus®",
    selectorLabel: "데일리스 아쿠아컴포트",
    maker: "Alcon",
    distributor: "한국알콘(주)",
    type: "근시·원시용 투명 구면 · 1일 교체",
    flag: "한국 공식 제품 페이지 없음 · MFDS 등록(아쿠아 렌즈)으로 유통 식별 · 현재 판매 여부 미확인",
    packageSpecs: [
  ...
  },
  {
    id: "total30",
    slug: "total30",
    aliases: ["토탈30", "TOTAL30", "워터렌즈 한달용", "lehfilcon A"],
    name: "토탈30® / TOTAL30®",
    selectorLabel: "토탈30",
    maker: "Alcon",
    distributor: "한국알콘(주)",
  ...
  },
  {
    ...
    aliases: ["에어옵틱스 플러스 하이드라글라이드", "AIR OPTIX plus HydraGlyde", "에어렌즈 하이드라", "lotrafilcon B"],
    name: "에어옵틱스® 플러스 하이드라글라이드® / AIR OPTIX® plus HydraGlyde®",
    selectorLabel: "에어옵틱스 플러스",
    maker: "Alcon",
    distributor: "한국알콘(주)",
    type: "근시·원시용 투명 구면 · 1달 교체",
    flag: "한국 공식 제품 페이지 없음 · MFDS 등록(에어렌즈 하이드라)으로 유통 식별 · 현재 판매 여부 미확인",
    packageSpecs: [
      { value: "BC 8.6", label: "Base Curve · mm" },
      { value: "DIA 14.2", label: "Diameter · mm" },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        caution: "MFDS 원장은 수허 07-856 호입니다. 쿠퍼비전코리아 전체 제품 목록 각주는 수허 07-568호로 적혀 있으며 이 번호는 MFDS 조회에서 0건입니다. 두 원문을 그대로 기록합니다.",
        sources: [
          {
            sourceType: "MFDS 허가·UDI",
            verifiedAt: "2026-08-28",
          ...
          },
          {
            ...
            linkNote: "이 번호로 MFDS 조회 시 0건 · 한국 목록 각주 원문 그대로 기록"
          },
          {
            sourceType: "한국 공식 페이지·IFU",
            verifiedAt: "2026-08-28",
